...
#Result
{
  output = streaming_score(input, Min=100,  Max=500, until = 0, batch=TRUE, remove= FALSE, embedding_size_p=0)  # onehot

  
  setwd("~/extension_AD/evaluations/total_result/concept_drift_result")
  write.csv(output, "result_model2_gradual_re10k_500_late.csv", row.names= FALSE)
}
