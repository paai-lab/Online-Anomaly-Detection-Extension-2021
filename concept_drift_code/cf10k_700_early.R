...
#Result
{
  output = streaming_score(input, Min=100,  Max=700, until = 0, batch=TRUE, remove= FALSE, embedding_size_p=0)  # onehot

  
  setwd("~/extension_AD/evaluations/total_result/concept_drift_result")
  write.csv(output, "result_model2_cf10k_700_early.csv", row.names= FALSE)
}
