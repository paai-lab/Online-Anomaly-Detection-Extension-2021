...
#Result
{
  ...
  write.csv(output_total, "result_model2_small.csv", row.names= FALSE)
}


# Min=100; start_index= i; Max=1000; until = 99; batch=TRUE; remove= FALSE; embedding_size_p=0, T=0.2
