...
#Result
{
  ...
  write.csv(output, "result_model1000_hospitalbilling.csv", row.names= FALSE)
}


# Min=100; start_index= i; Max=1000; until = 299; batch=TRUE; remove= FALSE; embedding_size_p=0
